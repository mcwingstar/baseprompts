# Alex Bilbie-Clarke - Career Advisory File
...
- Managed flagship audio products serving millions of users (ABC listen app, websites, triple j app)
- Led matrix team of 26 staff (4 direct reports: 2 PMs managing dev teams, 1 technical PM, 1 partnerships manager)
- Delivered 20% YOY growth in WAU for 3 consecutive years
...
- Limited understanding of M&A, capital allocation, or corporate growth mechanics
...
### MBA Focus (May 2026 - May 2027)

**Primary Objectives:**
1. Break the public sector typecast through clean exit and full-time immersion
2. Build finance and commercial credibility
3. Access corporate recruiting pipelines designed for career switchers
4. Create new proof points through Strategic Consulting Project

**Recommended Electives (6 courses):**

**Must Take:**
1. **Financial Strategy or M&A** - Build hard finance credibility, understand corporate growth mechanics
2. **Negotiation Skills** - Develop political/commercial negotiation muscle lacking from consensus-driven public sector
3. **Strategic Consulting Project** - Real corporate credential, client case study, network building
4. **Entrepreneurship from the Inside** - Bridge product background with intrapreneurship language

**Strong Considerations:**
5. **Advanced Finance** - Double down on commercial fundamentals
6. **Implementing Strategy** - Demonstrate execution capability in complex organizations

**Avoid:** Social Impact cluster (reinforces public sector typecasting), Change Management theory (too academic), Project Management (too tactical)
...
**Why Leave ABC?**
"I'm proud of building products that serve millions of Australians, but I'm seeking environments where decisions move faster and commercial pressure drives focused innovation. The MBA is my bridge to bring deep product craft into organizations that move at the pace I want to work."
...
- Engage with AI/ML product communities given strategic interest
- Connect with UNSW MBA alumni working in target companies
- Join Australian product leadership Slack/Discord communities

### During MBA (May 2026 - May 2027)

**Strategic Networking:**
- Target Strategic Consulting Project with Series B-D tech company or scale-up
- Use Global Network Weeks for international exposure (NYU Stern, London Business School, Kellogg)
- Build relationships with MBA peers from consulting, tech, and finance backgrounds
- Engage UNSW career services for corporate introductions

**Alumni Leverage:**
- Identify UNSW MBA alumni at target companies (Atlassian, Canva, Airwallex, etc.)
- Request informational interviews to understand culture and hiring needs
- Position yourself for post-MBA recruitment pipelines

### Target Companies (Sydney Focus)

**Tier 1 Targets (Ideal Culture Fit):**
- Canva (scale-up, product-driven, AI focus)
- Atlassian (established but product culture, scale)
- Airwallex (fintech, fast growth)
- SafetyCulture (B2B SaaS, strong product org)
- Campaign Monitor / CM Group (marketing tech)

**Tier 2 Targets (Good Alternatives):**
- Employment Hero (HR tech, growing fast)
- Deputy (workforce management)
- Zip Co (fintech, product-led)
- Propeller Aero (enterprise SaaS, AI/ML)
- Brighte (sustainable fintech)

**Tier 3 (Backup / Learning):**
- Media companies with digital transformation needs (Nine, News Corp digital)
- Consulting firms with product practices (BCG Digital Ventures, McKinsey Digital)
- Corporate innovation arms of banks (CBA X15, NAB Ventures)
...
**Q2 2026 (May Start):**
- Exit ABC gracefully, maintain relationships
- Begin MBA program (Foundations of Managerial Skills)
- Map out elective selection aligned with finance/commercial goals
- Start building MBA cohort relationships

### MBA Year (May 2026 - May 2027)

**Term 1 (May-Aug 2026):**
- Complete core courses with focus on finance fundamentals
- Identify Strategic Consulting Project sponsors
- Attend corporate recruiting events
- Begin informational interviews with target companies

**Term 2 (Sep-Dec 2026):**
- Execute Strategic Consulting Project (aim for tech/scale-up client)
- Select and complete recommended electives
- Leverage Global Network Week for international exposure
- Cultivate relationships with MBA peers in tech/consulting

**Term 3 (Jan-May 2027):**
- Complete remaining electives
- Activate job search through MBA recruiting channels
- Target graduation with 2-3 corporate offers in hand
- Negotiate compensation leveraging multiple offers

### Post-MBA (Mid 2027+)

**Immediate (Graduation):**
- Transition into senior product role or GM track position
- Target $220k+ total comp
- Join company with strong AI focus and fast-paced culture

**1-2 Years:**
- Build commercial track record and P&L exposure
- Develop finance literacy through real business context
- Position for VP Product or General Management role

**3-5 Years:**
- VP Product or GM role at scale-up
- Build portfolio of commercial product successes
- Consider entrepreneurship or C-suite track

## Red Flags to Watch For

**During Job Search:**
- Companies with slow decision-making (if interview process drags, culture likely similar)
- Organizations without clear product strategy or vision
- Roles without measurable outcomes or accountability
- Teams with high turnover or negative Glassdoor patterns
- Offers significantly below market without compelling equity story

**During Interviews:**
- Excessive focus on process over outcomes
- Lack of clarity on success metrics
- Heavy consensus-driven decision making (reminds you of ABC)
- Limited investment in product/design/tech
- Poor product-market fit or unclear business model
